...
class ChampTopBrandScreen extends Component{
    state = {
        isLoading:true,
    }
async componentDidMount(){
    await this.props.fetchProductsByBrand (this.props.navigation.getParam('brand'));
...
mapStateToProps = (state) => ({
  ...
  const mapDispatchToProps = (dispatch) => ({
    fetchProductsByBrand :(brand)=>dispatch(champSearchAction.fetchProductsByBrand (brand))
  });
  export default connect(mapStateToProps,mapDispatchToProps)(ChampTopBrandScreen);