...
class ChampBarcodeScreen extends Component{
    state = {
        isLoading:true,
    }
async componentDidMount(){
  console.log(this.props.navigation.getParam('barcode'));
    const res = await this.props.fetchProductsByBarcode(this.props.navigation.getParam('barcode'));
    console.log(res);
...
mapStateToProps = (state) => ({
  ...
  fetchProductsByBarcode:(barcode)=>dispatch(champSearchAction.fetchProductsByBarcode(barcode))
  });
  export default connect(mapStateToProps,mapDispatchToProps)(ChampBarcodeScreen);