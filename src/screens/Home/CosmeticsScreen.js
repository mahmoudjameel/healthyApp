...
class CosmeticsScreen extends Component{
  state={
    loading:false,
    searchData:null,
    categoryId:null
  ...
  async componentDidMount() {
    ...
    await this.props.fetchCosmetics();
  ...
  _onSearch=()=>{
    ...
    this.props.navigation.navigate({
      routeName: 'CosmeticSearchResult',
      params:{
    ...
    render(){
        ...
        <Content>
              ...
              <View style={{flex: 1,alignItems: 'center',marginTop:"10%"}}>
                  ...
                  <View style={{backgroundColor:"#0000",borderColor:"#009479",borderWidth:1,borderRadius:8,marginTop:"3%"}}>
                  <Icon name="qrcode-scan" type="MaterialCommunityIcons" style={{fontSize:40, color:"#009479",padding:15}} onPress={()=>this.props.navigation.navigate('CosmeticBarcodeSearch')}></Icon>
                  </View>
                </View>
...
const mapDispatchToProps = (dispatch) => ({
    fetchCosmetics:()=>dispatch(cosmeticAction.fetchCosmetics()), 
    fetchCategories:()=>dispatch(cosmeticAction.fetchCosmeticsCategories())
  });
export default connect(mapStateToProps,mapDispatchToProps)(CosmeticsScreen);