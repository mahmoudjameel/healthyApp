...
class PesticidesScreen extends Component{
  state={
    loading:false,
    categoryId:null
  }
  ...
  async componentDidMount() {
    ...
    await this.props.fetchPesticides();
  ...
  _onSearch=()=>{
    ...
    this.props.navigation.navigate({
      routeName: 'PesticideSearchResult',
      params:{
    ...
    render(){
        ...
        return(
          ...
          <Col style={{width:"15%",justifyContent:"center",alignContent:"center"}}>
              ...
              {this.props.language.pesticides}
           </Text>
              </Col>
              <Col style={{width:"15%",justifyContent:"center",alignContent:"center"}}>
        ...
        <Content>
              ...
              <View style={{flex: 1,alignItems: 'center',marginTop:"10%"}}>
                  ...
                  <Icon name="qrcode-scan" type="MaterialCommunityIcons" style={{fontSize:40, color:"#009479",padding:15}} onPress={()=>this.props.navigation.navigate('PesticideBarcodeSearch')}></Icon>
                  </View>
                </View>
              ...
              <Row style={{justifyContent: 'center', alignItems: 'center',width:"95%",marginTop:"10%"}}>
                  ...
                  <Col style={{width:"70%",height:50,borderRadius:10,backgroundColor:"#ddd"}}>
                    <ListItem style={{height:50}} noBorder>
...
const mapDispatchToProps = (dispatch) => ({
    fetchPesticides:()=>dispatch(pesticideAction.fetchPesticides()), 
    fetchCategories:()=>dispatch(pesticideAction.fetchPesticideCategories())
  });
export default connect(mapStateToProps,mapDispatchToProps)(PesticidesScreen);