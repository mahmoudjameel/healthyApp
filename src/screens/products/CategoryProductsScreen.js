...
class CategoryProductsScreen extends Component{
  state={
    ...
    constructor (props){
      ...
      render(){
        ...
        const categoryProducts = this.props.availableProducts.availableProducts.filter(prod=>prod.product_category.id === this.state.catId)
...
export default connect(mapStateToProps,mapDispatchToProps)(CategoryProductsScreen);