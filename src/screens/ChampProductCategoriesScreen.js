...
class ChampProductCategoriesScreen extends Component{
    state = {
        isLoading:true,
    }
async componentDidMount(){
    await this.props.fetchProductsByCategories(this.props.navigation.getParam('categories'));
...
mapStateToProps = (state) => ({
  ...
  const mapDispatchToProps = (dispatch) => ({
    fetchProductsByCategories:(categories)=>dispatch(champSearchAction.fetchProductsByCategories(categories))
  });
  export default connect(mapStateToProps,mapDispatchToProps)(ChampProductCategoriesScreen);