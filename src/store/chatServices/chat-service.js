...
import { fetchDialogs, sortDialogs, updateDialog, addNewDialog, deleteDialog } from '../actions/chat/dialogs'
import { pushMessage, fetchMessages, lazyFetchMessages, updateMessages, deleteAllMessages } from '../actions/chat/messages'
import { selectDialog, unselectDialog } from '../actions/chat/selectedDialog'
import { fetchUsers } from '../actions/chat/users'
...
class ChatService {
  ...
  //   const dialogs = store.getState().chatDialogs
  //   let dialog = null
  ...
  //   const result = store.getState().chatMessages
  ...
  //     },
  //   };
  //   const response=await ConnectyCube.users.get(params)
  //   user = response.items[0]
  //   return user
  // }
  // getUserFromReduxById(id) {

  //   return store.getState().chatUsers.users[id]
  // }
  ...
  // get currentUser() {
  //   return store.getState().chatCurrentUser
  // }
